...
for i, data in enumerate(data_matrix):
    ...
    ax.bar3d(x_pos, y_pos, z_pos, dx, dy, dz, color=colors[i], shade=True, alpha=0.9, zsort='average')
...
ax.set_yticklabels(row_names, verticalalignment='baseline', horizontalalignment='left', fontsize=11)
